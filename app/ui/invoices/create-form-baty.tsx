...
import { createInvoiceBaty } from "@/app/lib/actions";

export default function FormBaty({ weathers }: { weathers: Weather[] }) {
  return (
    <form action={createInvoiceBaty}>
          ...
          <div className="relative">
            ...
            >
              ...
              {weathers.map((weather, index) => (
                <option key={index}>{weather.city}</option>
              ))}
            </select>
