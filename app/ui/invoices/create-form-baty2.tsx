import { CustomerFieldCities, Weatherss } from "@/app/lib/definitions";
import Link from "next/link";
import { SunIcon, UserCircleIcon } from "@heroicons/react/24/outline";
import { Button } from "@/app/ui/button";
import { createInvoiceBaty2 } from "@/app/lib/actions";

export default function FormBaty2({
  cities,
}: {
  cities: CustomerFieldCities[];
}) {
  return (
    <form action={createInvoiceBaty2}>
